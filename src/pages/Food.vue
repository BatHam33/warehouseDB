...
<br><div style="text-align:center; font-weight:bold; font-size:250%;">Product Category: Food</div><br>
    <br /><br />
    ...
    <b-table-simple hover small caption-top responsive>
      ...
      <b-tbody>
        <b-tr v-for="product in products" :key="product.productid">
          <b-td v-if="product.categoryid==1">{{ product.productname }}</b-td>
          <b-td v-if="product.categoryid==1">${{ product.productprice }}</b-td>
          <b-td v-if="product.categoryid==1">{{ product.productlocation }}</b-td>
          <b-td v-if="product.categoryid==1">
            <b-button-group>
              <b-button
 ...
 <b-dropdown tag="b-dropdown" class="float-left" text="Filter By Category: Food"  style="margin-left:10px;">
