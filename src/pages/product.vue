...
<template>
  <div>
    ...
    <br><div style="text-align:center; font-weight:bold; font-size:250%;">Products</div><br>
    <br /><br />
 ...
 <b-dropdown tag="b-dropdown" class="float-left" text="Filter By Category:"  style="margin-left:10px;">
